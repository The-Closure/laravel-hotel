...
@section('content')
    <div class="content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    <form method="post" action="{{route('admin.setting.update','test')}}" autocomplete="off" class="form-horizontal" enctype="multipart/form-data">
                        @csrf
                        @method('put')
                        <div class="card ">
                            ...
                            <div class="card-body ">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-7">
                                        <div class="form-group{{ $errors->has('hotel_name') ? ' has-danger' : '' }}">
                                            <input  class="form-control{{ $errors->has('hotel_name') ? ' is-invalid' : '' }}"
                                                    name="hotel_name"
                                                    id="input-name"
                                                    type="text"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-7">
                                        <div class="form-group{{ $errors->has('hotel_email') ? ' has-danger' : '' }}">
                                            <input class="form-control{{ $errors->has('hotel_email') ? ' is-invalid' : '' }}"
                                                    name="hotel_email"
                                                    id="input-name"
                                                    type="email"
                                                    placeholder="{{ __('hotel email') }}"
                                                    required="true"
                                                    value="{{ $setting['hotel_email'] }}"
                                                    aria-required="true" />
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-7">
                                        <div class="form-group{{ $errors->has('hotel_phone') ? ' has-danger' : '' }}">
                                            <input class="form-control{{ $errors->has('hotel_phone') ? ' is-invalid' : '' }}"
                                                    name="hotel_phone"
                                                    id="input-name"
                                                    type="text"
                                                    placeholder="{{ __('hotel phone') }}"
                                                    required="true"
                                                    value="{{ $setting['hotel_phone'] }}"
                                                    aria-required="true" />
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-7">
                                        <div class="form-group{{ $errors->has('hotel_address') ? ' has-danger' : '' }}">
                                            <input class="form-control{{ $errors->has('hotel_address') ? ' is-invalid' : '' }}"
                                                    name="hotel_address"
                                                    id="input-name"
                                                    type="text"
                                                    placeholder="{{ __('hotel address') }}"
                                                    required="true"
                                                    value="{{ $setting['hotel_address'] }}"
                                                    aria-required="true" />
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-9">
                                        <input name="logo" accept="image/*" type="file" class="form-control" data-show-caption="false" data-show-upload="false" data-fouc>
                                    </div>
                                </div>
                            </div>
